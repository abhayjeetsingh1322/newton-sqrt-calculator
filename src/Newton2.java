 ...
 * response, the program proceeds or quits. This program is designed to handle
 * both positive numbers and zeros. The program runs until user quits when the
 * response is not equal to "y".
 *
 * @author A. Singh
 *
 */
public final class Newton2 {
    ...
    private static double sqrt(double x) {
        ...
        if (estimate > 0.0) {
            ...
            //Using while loop to check for relative error 0.01%
